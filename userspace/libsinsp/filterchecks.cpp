...
const filtercheck_field_info sinsp_filter_check_thread_fields[] =
{
  ...
  // would be better as a PF_BOOL, but that doesn't exist yet
	...
	{PT_INT64, EPF_NONE, PF_DEC, "thread.vtid", "the id of the thread generating the event as seen from its current PID namespace."},
	{PT_INT64, EPF_NONE, PF_DEC, "proc.vpid", "the id of the process generating the event as seen from its current PID namespace."},
